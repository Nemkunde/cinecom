...
import { movieActorsTable, movieDirectorsTable, movieGenresTable, moviesTable } from '../db/schema';
...
export const deleteMovie = async (id: number) => {
    try {
        const result = await db.delete(moviesTable).where(eq(moviesTable.movie_id, id)).returning();
